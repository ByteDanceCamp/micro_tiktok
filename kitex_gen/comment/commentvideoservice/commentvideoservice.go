...
func serviceInfo() *kitex.ServiceInfo {
	return commentVideoServiceServiceInfo
}

var commentVideoServiceServiceInfo = NewServiceInfo()

func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "CommentVideoService"
	handlerType := (*comment.CommentVideoService)(nil)
...
func commentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(comment.CommentVideoService).Comment(ctx, req)
		if err != nil {
			return err
		}
	...
	case *CommentArgs:
		success, err := handler.(comment.CommentVideoService).Comment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func listHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(comment.CommentVideoService).List(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ListArgs:
		success, err := handler.(comment.CommentVideoService).List(ctx, s.Req)
		if err != nil {
			return err
		}
...
func countResHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		...
		resp, err := handler.(comment.CommentVideoService).CountRes(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *CountResArgs:
		success, err := handler.(comment.CommentVideoService).CountRes(ctx, s.Req)
		if err != nil {
			return err
		}
